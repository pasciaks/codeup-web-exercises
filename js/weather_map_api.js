...
(() => {
    ...
    function forecastByCity(city) {
        return fetch(`https://api.openweathermap.org/data/2.5/forecast?q=${city}&appid=${WEATHER_API_KEY}`)
            .then(res => res.json())
            .then(data => {
                return data;
            })
    ...
    async function submitForm(event) {
        ...
        // getLiveForecastDataFromGpsCoords({lng: -87.6358938589772, lat: 41.8598600675018});
